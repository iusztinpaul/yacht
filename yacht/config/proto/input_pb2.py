...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1eyacht/config/proto/input.proto\x12\x12yacht.config.proto\x1a!yacht/config/proto/backtest.proto\x1a\x1fyacht/config/proto/period.proto\"\x8e\x05\n\x0bInputConfig\x12\x0e\n\x06market\x18\x01 \x01(\t\x12\x15\n\rmarket_mixins\x18\x02 \x03(\t\x12\x0f\n\x07\x64\x61taset\x18\x03 \x01(\t\x12\x16\n\x0eis_multi_asset\x18\x04 \x01(\x08\x12\x1e\n\x16num_assets_per_dataset\x18\x05 \x01(\x05\x12\x0e\n\x06scaler\x18\x06 \x01(\t\x12\x19\n\x11scale_on_interval\x18\x07 \x01(\t\x12\x0f\n\x07tickers\x18\x08 \x03(\t\x12\x19\n\x11\x66ine_tune_tickers\x18\t \x03(\t\x12\x11\n\tintervals\x18\n \x03(\t\x12\x10\n\x08\x66\x65\x61tures\x18\x0b \x03(\t\x12\x1e\n\x16\x64\x65\x63ision_price_feature\x18\x0c \x01(\t\x12\x1c\n\x14technical_indicators\x18\r \x03(\t\x12\r\n\x05start\x18\x0e \x01(\t\x12\x0b\n\x03\x65nd\x18\x0f \x01(\t\x12\x15\n\rperiod_length\x18\x10 \x01(\t\x12\x13\n\x0bwindow_size\x18\x11 \x01(\x05\x12\x19\n\x11window_transforms\x18\x12 \x03(\t\x12\x13\n\x0bnum_periods\x18\x13 \x01(\x05\x12\x38\n\x0erender_periods\x18\x14 \x03(\x0b\x32 .yacht.config.proto.PeriodConfig\x12\x18\n\x10include_weekends\x18\x15 \x01(\x08\x12\x1e\n\x16validation_split_ratio\x18\x16 \x01(\x01\x12\x1c\n\x14\x62\x61\x63ktest_split_ratio\x18\x17 \x01(\x01\x12\x15\n\rembargo_ratio\x18\x18 \x01(\x01\x12\x34\n\x08\x62\x61\x63ktest\x18\x19 \x01(\x0b\x32\".yacht.config.proto.BacktestConfigb\x06proto3')
  ,
...
_INPUTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='technical_indicators', full_name='yacht.config.proto.InputConfig.technical_indicators', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start', full_name='yacht.config.proto.InputConfig.start', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end', full_name='yacht.config.proto.InputConfig.end', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='period_length', full_name='yacht.config.proto.InputConfig.period_length', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='window_size', full_name='yacht.config.proto.InputConfig.window_size', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='window_transforms', full_name='yacht.config.proto.InputConfig.window_transforms', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_periods', full_name='yacht.config.proto.InputConfig.num_periods', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='render_periods', full_name='yacht.config.proto.InputConfig.render_periods', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='include_weekends', full_name='yacht.config.proto.InputConfig.include_weekends', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validation_split_ratio', full_name='yacht.config.proto.InputConfig.validation_split_ratio', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='backtest_split_ratio', full_name='yacht.config.proto.InputConfig.backtest_split_ratio', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='embargo_ratio', full_name='yacht.config.proto.InputConfig.embargo_ratio', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='backtest', full_name='yacht.config.proto.InputConfig.backtest', index=24,
