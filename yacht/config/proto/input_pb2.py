...
_INPUTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='include_weekends', full_name='yacht.config.proto.InputConfig.include_weekends', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='backtest_split_ratio', full_name='yacht.config.proto.InputConfig.backtest_split_ratio', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='backtest_embargo_ratio', full_name='yacht.config.proto.InputConfig.backtest_embargo_ratio', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='backtest', full_name='yacht.config.proto.InputConfig.backtest', index=14,
