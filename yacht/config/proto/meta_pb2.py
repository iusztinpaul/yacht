...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1dyacht/config/proto/meta.proto\x12\x12yacht.config.proto\"U\n\nMetaConfig\x12\x0e\n\x06\x64\x65vice\x18\x01 \x01(\t\x12\x1b\n\x13log_frequency_steps\x18\x02 \x01(\x05\x12\x1a\n\x12\x65xperiment_tracker\x18\x03 \x01(\tb\x06proto3')
)
...
_METACONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='log_frequency_steps', full_name='yacht.config.proto.MetaConfig.log_frequency_steps', index=1,
