...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1dyacht/config/proto/meta.proto\x12\x12yacht.config.proto\"\xb4\x01\n\nMetaConfig\x12\x0e\n\x06\x64\x65vice\x18\x01 \x01(\t\x12\x1f\n\x17metrics_to_save_best_on\x18\x02 \x03(\t\x12\x1f\n\x17metrics_to_load_best_on\x18\x03 \x03(\t\x12\x1b\n\x13plateau_max_n_steps\x18\x04 \x01(\x05\x12\x1b\n\x13log_frequency_steps\x18\x05 \x01(\x05\x12\x1a\n\x12\x65xperiment_tracker\x18\x06 \x01(\tb\x06proto3')
)
...
_METACONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='plateau_max_n_steps', full_name='yacht.config.proto.MetaConfig.plateau_max_n_steps', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log_frequency_steps', full_name='yacht.config.proto.MetaConfig.log_frequency_steps', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='experiment_tracker', full_name='yacht.config.proto.MetaConfig.experiment_tracker', index=5,
