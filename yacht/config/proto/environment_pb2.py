...
_ENVIRONMENTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='reward_schema', full_name='yacht.config.proto.EnvironmentConfig.reward_schema', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reward_scaling', full_name='yacht.config.proto.EnvironmentConfig.reward_scaling', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='action_schema', full_name='yacht.config.proto.EnvironmentConfig.action_schema', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_units_per_asset', full_name='yacht.config.proto.EnvironmentConfig.max_units_per_asset', index=4,
